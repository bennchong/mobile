    ...
    >
      <View style={{ alignItems: "center", justifyContent: "center" }}>
        <Text style={{fontSize: 16, fontFamily: 'calibri-regular', textAlign: 'center'}}>
          ...
          To give us feedback, visit </Text><Hyperlink linkDefault={true} linkStyle={ { color: '#2963b9', fontSize: 20, fontFamily: 'calibri-regular' } }><Text>https://www.mom.gov.sg/contact</Text></Hyperlink><Text>{'\n'}{'\n'}
          {'\n'}{'\n'}{'\n'}{'\n'}{'\n'}{'\n'}{'\n'}{'\n'}{'\n'}{'\n'}{'\n'}{'\n'}
